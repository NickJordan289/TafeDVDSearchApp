...
//    final String mainDir = mainClass.substring(0, mainClass.indexOf("build"));
    ...
    public DVDSearchApp(String[] args) {
        ...
        try {
            String titlesPath = "TITLES.xls";
            if(args.length > 0) {
                titlesPath = args[0];
            }
//            FileInputStream fileInputStream = new FileInputStream(new File(mainDir + "\\TITLES.xls"));
            FileInputStream fileInputStream = new FileInputStream(new File(titlesPath));
